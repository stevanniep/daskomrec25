<div id="popupShift" class="fixed hidden z-auto inset-0 flex items-center justify-center text-primary font-crimson-text bg-BlackLayer">
    ...
    <div class="absolute mx-[90px] lg:mx-[560px] md:mx-[300px] sm:mx-[180px]">
        ...
        <div class="text-center mx-auto">
            ...
            <p class="lg:text-4xl md:text-3xl text-lg mt-1 md:mt-3 lg:mt-3 font-im-fell-english">Are you sure you want to add this shift?</p>
        </div>  
        <div class="mt-4 sm:mt-8 lg:mt-10 md:mt-10 space-x-2">
            <button class="relative text-primary transition-all duration-300 ease-in-out transform hover:scale-105 active:scale-95 list-none">
                <a href="/Shift"><img src="assets/Button Pink.png" alt="Yes" class="w-[80px] xs:w-[100px] lg:w-[180px] md:w-[180px] sm:w-[150px]">
                <p class="absolute inset-0 flex items-center justify-center text-md lg:text-xl md:text-xl font-bold">Yes</p></a>
            </button>
            <button onclick="hideShift()" class="relative text-primary transition-all duration-300 ease-in-out transform hover:scale-105 active:scale-95 list-none">
